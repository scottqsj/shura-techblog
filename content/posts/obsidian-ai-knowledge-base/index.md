...
knowledge-base/
├── 01-项目/
│   ├── AI助手Hermes配置.md       # Hermes Agent 配置
│   ├── 技术博客-Shuratechblog.md  # 博客发布流程
│   ├── 股票分析Docker.md          # Docker 股票分析
│   └── A股选股脚本.md             # 选股脚本细节
├── 02-网络与基础设施/
│   ├── 网络拓扑.md                # 设备 IP、端口、跨子网
│   └── Xray代理配置.md            # 代理端口和路径
├── 03-AI与工具/
│   ├── AI模型配置.md              # 各模型、API、用途
│   └── Open-WebUI配置.md          # WebUI 部署
├── 04-偏好与规范/
│   └── 编码铁律与工作流偏好.md     # 踩过的坑、工作习惯
└── 05-快速索引/
    └── 快速查找索引.md             # 全局导航页
```

结构很简单：按大类分文件夹，每篇笔记尽量「原子化」——一篇笔记只讲一个主题。
